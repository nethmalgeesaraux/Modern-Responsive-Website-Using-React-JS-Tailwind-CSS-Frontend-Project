    ...
    return (
        <div className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">
            ...
            <div className={`text-gray-700 dark:text-white sm:text-sm 
                     ${!isMenuOpen ? `max-sm:w-0 overflow-hidden` : `max-sm:w-60 max-sm:pl-10`} max-sm:fixed top-0 bottom-0 right-0 
                ...
                <a onClick={() => setIsMenuOpen(false)} href="#services" className="sm:hover:border-b">Services</a>
                <a onClick={() => setIsMenuOpen(false)} href="#our-work" className="sm:hover:border-b">Our Work</a>
                <a onClick={() => setIsMenuOpen(false)} href="#contact-us" className="sm:hover:border-b">Contact Us</a>
            </div>
